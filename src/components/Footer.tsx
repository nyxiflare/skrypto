    ...
    <footer className="py-16 px-4 border-t border-white/10">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/70 mb-4">
              The truly anonymous crypto freelance platform. Work, earn, and thrive without compromising your privacy.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white/50 hover:text-skrypto-purple transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/disclaimer" className="text-white/70 hover:text-white transition-colors">Legal Disclaimer</Link></li>
              <li><Link to="/cookies" className="text-white/70 hover:text-white transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">Join the Revolution</h3>
            <p className="text-white/70 mb-4">
            ...
            <div className="flex">
              <input 
                ...
                className="bg-skrypto-darker w-full rounded-l-lg py-2 px-3 text-white border-y border-l border-white/10 focus:outline-none focus:border-skrypto-purple"
              />
              <Button className="bg-skrypto-purple hover:bg-skrypto-purple/90 text-white rounded-l-none">
                Subscribe
              </Button>
            </div>
          </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-white/50">
          <p>© {new Date().getFullYear()} Skrypto. All rights reserved.</p>
          <p className="mt-2 text-sm">
            Skrypto is a decentralized platform. We do not collect personal information or enforce KYC requirements.
          </p>
        </div>
      </div>
    </footer>
